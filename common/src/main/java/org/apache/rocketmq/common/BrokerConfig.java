...
public class BrokerConfig {
    ...
    /**
     * ROCKETMQ_HOME 环境变量， rocketmq 根路径
     */
    private String rocketmqHome = System.getProperty(MixAll.ROCKETMQ_HOME_PROPERTY, System.getenv(MixAll.ROCKETMQ_HOME_ENV));

    /**
     * NAMESRV_ADDR 环境变量，namesrv IP地址
     * ImportantField 注解用于打印日志
     */
    @ImportantField
    ...
    /**
     * broker IP
     * brokerIP1 指示 Broker 服务地址
     * brokerIP2 指示 BrokerHA IP 地址，供 slave 同步消息的地址
     */
    @ImportantField
    ...
    /**
     * brokerId
     * todo rocketmq 使用 brokerId 指示集群中的主从身份，同一个 brokerName下，Id 为 0 时为主节点
     * 默认值 MASTER_ID 为 0
     */
    @ImportantField
    ...
    /**
     * broker 权限，默认为 6 表示可读可写
     */
    private int brokerPermission = PermName.PERM_READ | PermName.PERM_WRITE;

    /**
     * 默认的主题队列数量，即在一个 broker 节点的一个主题下，共有 8 个队列用于存储消息
     */
