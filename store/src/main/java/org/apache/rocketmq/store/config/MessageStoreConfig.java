...
public class MessageStoreConfig {
    ...
    /**
     * broker 存储根目录，默认为当前用户根目录下 store 文件夹
     */
    @ImportantField
    ...
    /**
     * 消息队列存储地址，默认为根目录下 commitlog 文件，该文件是 broker 存储消息的文件，broker从
     * producer 收到的所有消息均存在该文件中
     */
    @ImportantField
    ...
    /**
     * 单个 commitlog 的最大容量，默认为 1G
     */
    private int mappedFileSizeCommitLog = 1024 * 1024 * 1024;
    // ConsumeQueue file size,default is 30W
    /**
     * 单个 ConsumeQueue 文件的最大容量，默认为 30W 条，单条记录为 20 位
     */
